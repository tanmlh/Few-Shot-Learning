...
# net_conf['feature']['pre_trained'] = '../model/pretrain_MiniImageNet_ConvNet/network_best.pkl'

## Options for relation network
net_conf['relation'] = {}
net_conf['relation']['num_features'] = [256 * 4 * 4, 128, 64]
...
## Options for solver
solver_conf = {}
solver_conf['solver_name'] = 'MiniImageNet_MetaRelationNet_5way1shot_ConvNet_1001'
...
loader_conf['train_batch_size'] = 8
loader_conf['test_batch_size'] = 8
